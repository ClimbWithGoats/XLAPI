...
namespace ConsoleXLAPI.StaticController
{
    ...
    public static partial class XLMainController
    {
        ...
        {
            // Debug.WriteLine($"Metoda {nameof(SprawdzWersje)} działa na wątku o ID: {Environment.CurrentManagedThreadId}");
        ...
        public static void CreateLoginObjectAndLogin(XLLoginInfo account)
        {
            ...
            // Debug.WriteLine($"Metoda {nameof(CreateLoginObjectAndLogin)} działa na wątku o ID: {Environment.CurrentManagedThreadId}");
        ...
        {
            // Debug.WriteLine($"Metoda {nameof(Zaloguj)} działa na wątku o ID: {Environment.CurrentManagedThreadId}");
            object[] args = { obj, 0 };
        ...
        {
            // Debug.WriteLine($"Metoda {nameof(Wyloguj)} działa na wątku o ID: {Environment.CurrentManagedThreadId}");
            object[] args = { Sesja };
        ...
        {
            // Debug.WriteLine($"Metoda {nameof(PobierzIloscZdarzen)} działa na wątku o ID: {Environment.CurrentManagedThreadId}");
