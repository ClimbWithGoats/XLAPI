...
namespace ConsoleXLAPI.StaticController
{
    ...
    public static partial class XLMainController
    {
        public static void AddOrUpdateCommodity(XLTowarInfo commodity)
        {
            ...
            // Debug.WriteLine($"Metoda {nameof(AddOrUpdateCommodity)} działa na wątku o ID: {Environment.CurrentManagedThreadId}");
        ...
        {
            // Debug.WriteLine($"Metoda {nameof(AddCommodities)} działa na wątku o ID: {Environment.CurrentManagedThreadId}");
