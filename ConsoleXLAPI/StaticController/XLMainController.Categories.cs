...
namespace ConsoleXLAPI.StaticController
{
    ...
    public static partial class XLMainController
    {
        ...
        {
            // Debug.WriteLine($"Metoda {nameof(AddOrUpdateCategories)} działa na wątku o ID: {Environment.CurrentManagedThreadId}");
        ...
        {
            // Debug.WriteLine($"Metoda {nameof(AddCategories)} działa na wątku o ID: {Environment.CurrentManagedThreadId}");
