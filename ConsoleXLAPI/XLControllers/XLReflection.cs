...
namespace ConsoleXLAPI.XLControllers
{
    public class XLReflection
    {
        ...
        {
            // Debug.WriteLine($"Metoda {nameof(GetMethodAndInvoke)} działa na wątku o ID: {Environment.CurrentManagedThreadId}");
            ...
            lock (lockObject)
            {
                ...
                if (method != null)
                {
                    ...
                    {
                        // Debug.WriteLine("ex getmethod TargetInvocationException" + ex.Message);
                        // Debug.WriteLine("ex getmethod TargetInvocationException" + ex.InnerException);
                    }
                    catch (SEHException ex)
                    {
                        // Debug.WriteLine("ex getmethod SEHException" + ex.Message);
                        // Debug.WriteLine("ex getmethod SEHException" + ex.InnerException);
                    }
                    catch (Exception ex)
                    {
                        // Debug.WriteLine("ex getmethod Exception" + ex.Message);
                        // Debug.WriteLine("ex getmethod Exception" + ex.InnerException);
                    }
                    finally
                    {
                        //if (comObject != null)
