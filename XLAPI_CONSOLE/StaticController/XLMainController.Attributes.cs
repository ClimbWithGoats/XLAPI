...
namespace XLAPI_CONSOLE.StaticController
{
    ...
    public static partial class XLMainController
    {
        ...
        {
            XLAtrybutInfo xLAtrybut = new XLAtrybutInfo()
            {
            ...
            foreach (var item in attributes)
            {
                ...
                //    Console.WriteLine(nameof(PrepareObjectAndInvokeMethod) + "koniec atrybuty");
        ...
        private static XLResponse TryAddObjectToClass(int? gIDTyp, int classid)
        {
            ...
            Console.WriteLine(nameof(TryAddObjectToClass) + " " + gIDTyp);
